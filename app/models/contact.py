...
class Contact(Base):
    ...
    owner_id: Mapped[int] = mapped_column(ForeignKey("users.id"), nullable=False)  # ForeignKey can be added when User model is uncommented
    ...
    def __repr__(self) -> str:
        return (f"Contact(id={self.id!r}, firstname={self.firstname!r}, "
